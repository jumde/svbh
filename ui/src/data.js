...
const data = {
  ...
  dashBoardPage: {
    recentProducts: [
      {
        "id": 1,
        "title": "Support Immigrant children at the border",
        "text": "This will help with one week's worth of baby formula",
        "name": "RAICES, Texas",
        // "listing-status": 0,
        // "price": "2 ETH",
        // "category": [
      ...
      {
        "id": 2,
        "title": "Unite separated immigration children with their parents",
        "text": "This will pay for the lawyer fees for one family",
...

      {
        ...
        "text": "This will sponsor one child's academic year worth of school supplies",
      ...
      {
        "id": 4,
        "title": "Tech education for women",
        "text": "We provide 1 year's subscription for Udacity for 5 girls from underrepresented communities",
        "name": "Women Who code",
        // "listing-status": 0,
        // "price": "42 ETH",
        // "category": [
